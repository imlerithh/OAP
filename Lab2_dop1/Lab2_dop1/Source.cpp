//var12
//1. Дан файл вещественных чисел, содержащий элементы квадратной матрицы по строкам.Создать новый файл той же структуры, 
//содержащий k - ую строку исходной матрицы.
//2. Даны три файла целых чисел одинакового размера с именами NameA, NameB и NameC.Создать новый файл с именем NameD, в который записать 
